...
void cross_analysis             (void);                     //十字元素判断
void connect_point(uint8 *array_value, uint8 num0,uint8 num1);//连接两点 用于边界补线
uint8 find_jump_point(uint8 *array_value, uint8 num0, uint8 num1,uint8 jump_num, uint8 mode1);//找跳变点
