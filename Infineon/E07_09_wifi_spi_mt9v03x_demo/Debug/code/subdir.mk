...
code/PID.src: ../code/PID.c code/subdir.mk
	cctc -cs --dep-file="$(*F).d" --misrac-version=2004 -D__CPU__=tc26xb "-fD:/Infineon/E07_09_wifi_spi_mt9v03x_demo/Debug/TASKING_C_C___Compiler-Include_paths__-I_.opt" --iso=99 --c++14 --language=+volatile --exceptions --anachronisms --fp-model=3 -O0 --tradeoff=4 --compact-max-size=200 -g -Wc-w544 -Wc-w557 -Ctc26xb -Y0 -N0 -Z0 -o "$@" "$<"
...
clean-code:
	-$(RM) code/PID.d code/PID.o code/PID.src code/ekf.d code/ekf.o code/ekf.src code/image.d code/image.o code/image.src code/init.d code/init.o code/init.src code/island.d code/island.o code/island.src code/isp200_show.d code/isp200_show.o code/isp200_show.src code/leg_flexible.d code/leg_flexible.o code/leg_flexible.src code/matrix.d code/matrix.o code/matrix.src code/search_line.d code/search_line.o code/search_line.src code/small_driver_uart_control.d code/small_driver_uart_control.o code/small_driver_uart_control.src code/vmc.d code/vmc.o code/vmc.src
