...
#define WIFI_SSID_TEST          "supergerm"
#define WIFI_PASSWORD_TEST      "yangao060403"  // 如果需要连接的WIFI 没有密码则需要将 这里 替换为 NULL
...
int core0_main(void)
{
    ...
    // 对边界数组写入数据
    seekfree_assistant_camera_information_config(SEEKFREE_ASSISTANT_MT9V03X, image_copy[0], MT9V03X_W, MT9V03X_H);
    seekfree_assistant_camera_boundary_config(X_BOUNDARY, MT9V03X_H,points_l, middle,points_r, NULL, NULL ,NULL);
