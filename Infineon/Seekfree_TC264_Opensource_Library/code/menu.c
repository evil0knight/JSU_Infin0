...
void control_menu(void)
{
    ...
    if (place_index == 0 ) {
        ...
        if(value_index >= 1){
        pid1_walk.zhuanxiang.maxIntegral+=100;
        pid1_walk.zhuanxiang.maxIntegral+=100;
        value_index = 0;
        }
        if(value_index <= -1)
...
void image_menu_2(void)
{
    ...
    show_string_value(14,right[30]-left[30],3,"r[30]-l[30]");
    show_string_value(15,right[50]-left[50],3,"r[50]-l[50]");
    show_string_value(16,right[70]-left[70],3,"r[70]-l[70]");
    show_string_value(17,right[100]-left[100],3,"r[100]-l[100]");
    ips200_show_string(20,(value_number+1)*Font_size_H, "EXIT");
    image_process();
    int i;
    ips200_displayimage03x(imag[0], MT9V03X_W, MT9V03X_H);
...
void image_menu_3(void)
{
    ...
    show_string_value(12,turn_value,3,"turn_value");
    show_string_value(13,white_line1,3,"white_line1");
    show_string_value(14,white_line2,3,"white_line2");
    show_string_value(15,check_border_validity(left, right),3,"check_border");
