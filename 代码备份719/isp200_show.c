...
void show_pid2_flexible(void){
    ...
    ips200_show_string              (0, 160, "turn_value");
    ips200_show_float               (120, 160, -border, 4, 4);
    ips200_show_string              (0, 180, "zhuanxiang");
    ips200_show_float               (120, 180, pid2_flexible.zhuanxiang.output, 4, 4);
}
...
void show_pid1_walk(void){
    ips200_show_string              (0, 0, "turn_value");
    ips200_show_float               (120, 0,turn_value, 4, 4);
    ips200_show_string              (0, 20, "left_speed");
    ips200_show_int                 (120, 20, motor_value.receive_left_speed_data, 4);
    ...
    ips200_show_float               (120, 160, border, 4, 4);
    ips200_show_string              (0, 180, "zhuanxiang");
    ips200_show_float               (120, 180, pid1_walk.zhuanxiang.output, 4, 4);
    ips200_show_string              (0, 200, "island");
    //ips200_show_int               (120, 200, island, 4);
    ips200_show_string              (0, 220, "sum_island");
    //ips200_show_int               (120, 220, sum_island, 4);
    ips200_show_string              (0, 240, "cross_sum");
    //ips200_show_int               (120, 240, cross_sum, 4);
    ips200_show_string              (0, 260, "stop_position == 0");
    //ips200_show_int               (120, 260, stop_position, 4);
...
void show_stopworking(void){
    ...
    ips200_show_string              (0, 140, "border");
    ips200_show_float               (120, 140, border, 4, 4);
    ips200_show_string              (0, 160, "turn_value");
    ips200_show_float               (120, 160, turn_value, 4, 4);
    ips200_show_string              (0, 180, "zhuanxiang");
    ips200_show_float               (120, 180, pid1_walk.zhuanxiang.output, 4, 4);
    ips200_show_string              (0, 200, "island");
    //ips200_show_int               (120, 200, island, 4);
    ...
    ips200_show_string              (0, 240, "cross_sum");
    //ips200_show_int               (120, 240, cross_sum, 4);
    ips200_show_string              (0, 260, "BridgeState");
    //ips200_show_int               (120, 260, BridgeState, 4);
    ips200_show_string              (0, 260, "euler_angle.yaw");
    ips200_show_float               (120, 260, euler_angle.yaw, 4,4);
}
