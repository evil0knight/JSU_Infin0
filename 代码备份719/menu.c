...
void image_menu_3(void)
{
    ...
    show_string_value(14,check_border_white_excess(),3,"check_border_w");
    show_string_value(15,inc_y,3,"inc_y");
...
void image_menu_4(void)
{
    ...
    show_string_value_float(16,imageOut[0][90],3,3,"imageOut[0][90]");
    show_string_value(17,0,3,"nextpage");
    ips200_show_string(20,(value_number+1)*Font_size_H, "EXIT");
    int i;
